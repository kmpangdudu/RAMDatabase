CREATE VIEW [dbo].[V_LastMonth_Top10_LastyearFrequently_Clicked_Resources]
AS
WITH B_ranked AS (
  SELECT
    *,
...
SELECT
  ...
  A.num as [Last Month Last year Num]
FROM (select top(10) * from V_LastMonth_LastyearFrequently_Clicked_Resources as vw order by vw.num desc) as A 
