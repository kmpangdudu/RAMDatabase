...
CREATE VIEW [dbo].[V_Lastweek_Browse_Lastyear_By_Category] AS
...
join 
 ...
 (logdate >= DATEADD(Year,-1,[dbo].[fn_lastweek_startday]())  and logdate < DATEADD(Year,-1,[dbo].[fn_lastweek_endday]()))
 group by kws.TID
 ) as a
