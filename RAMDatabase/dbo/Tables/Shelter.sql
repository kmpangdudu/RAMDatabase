CREATE TABLE [dbo].[Shelter] (
    ...
    [Map]                    NVARCHAR (50)    CONSTRAINT [DF_Shelter_Map] DEFAULT (N'Shelter') NULL,
    ...
    [createdDate]            DATETIME         CONSTRAINT [DF_Shelter_createdDate] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK_Shelter] PRIMARY KEY CLUSTERED ([ETLLoadID] ASC, [SubCategoryID] ASC, [TopCategoryID] ASC),
    CONSTRAINT [FK_Shelter_KHPCategory] FOREIGN KEY ([TopCategoryID]) REFERENCES [yos].[KHPCategory] ([KHPCategoryID])
);
