...
-- revison: Feb.10, 2016
-- revison: Mar.10, 2016     
-- REVISION Apr.10, 2016 ADD WHERE clause , it will read     WHERE	SC.Active = 1 AND TC.Active = 1
-- Reversion Aug. 15, 2016, added parameter @token, check what kind of resources the caller can get.
-- =======================================================================================================================================
create PROCEDURE p256
@lang nvarchar (50) =N' ',
@token NVARCHAR(50)
AS
BEGIN
