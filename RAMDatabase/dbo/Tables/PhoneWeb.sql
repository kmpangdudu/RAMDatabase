CREATE TABLE [dbo].[PhoneWeb] (
    ...
    [Map]                    NVARCHAR (50)    CONSTRAINT [DF_PhoneWeb_Map] DEFAULT (N'List') NULL,
    ...
    [createdDate]            DATETIME         CONSTRAINT [DF_PhoneWeb_createdDate] DEFAULT (getdate()) NULL,
    CONSTRAINT [PK_PhoneWeb_1] PRIMARY KEY CLUSTERED ([ETLLoadID] ASC, [SubCategoryID] ASC, [TopCategoryID] ASC),
    CONSTRAINT [FK_PhoneWeb_KHPCategory] FOREIGN KEY ([TopCategoryID]) REFERENCES [yos].[KHPCategory] ([KHPCategoryID])
);
