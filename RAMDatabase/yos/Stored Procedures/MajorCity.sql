...
--
------------------------------------
CREATE PROCEDURE [yos].[MajorCity]
@End int =1,
@D DATE = '2017-09-01'
AS
BEGIN
...
DECLARE @lat numeric (18,10) = 45.501302
DECLARE @long numeric (18,10) = -73.571751
DECLARE  @Mip NVARCHAR(20) = '70.48.125.146'
